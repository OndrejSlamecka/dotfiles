...
let s:N1   = [ '#282a36' , '#bd93f9' , 17  , 190 ]
let s:N2   = [ '#ffffff' , '#444444' , 255 , 238 ]
let s:N3   = [ '#f8f8f2' , '#282a36' , 85  , 234 ]
let g:airline#themes#dracula#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)

" Here we define overrides for when the buffer is modified.  This will be
" applied after g:airline#themes#dracula#palette.normal, hence why only certain keys are
" declared.
let g:airline#themes#dracula#palette.normal_modified = {
      \ 'airline_c': [ '#ffffff' , '#44475a' , 255     , 53      , ''     ] ,
      \ }


let s:I1 = [ '#f8f8f2' , '#ff79c6' , 17  , 45  ]
let s:I2 = [ '#ffffff' , '#444444' , 255 , 27  ]
let s:I3 = [ '#ffffff' , '#282a36' , 15  , 17  ]
...
let s:V1 = [ '#000000' , '#f1fa8c' , 232 , 214 ]
let s:V2 = [ '#000000' , '#444444' , 232 , 202 ]
let s:V3 = [ '#ffffff' , '#282a36' , 15  , 52  ]
...
let s:IA1 = [ '#7e7e7e' , '#1c1c1c' , 239 , 234 , '' ]
let s:IA2 = [ '#7e7e7e' , '#262626' , 239 , 235 , '' ]
let s:IA3 = [ '#7e7e7e' , '#303030' , 239 , 236 , '' ]
...
let g:airline#themes#dracula#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      \ [ '#d7d7ff' , '#bd93f9' , 189 , 55  , ''     ],
      \ [ '#ffffff' , '#875fd7' , 231 , 98  , ''     ],
      \ [ '#282a36' , '#ffffff' , 55  , 231 , 'bold' ])
